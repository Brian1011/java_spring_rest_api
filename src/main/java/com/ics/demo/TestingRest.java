...
//
        // find by id
        University findUni = feignRestClient.findById(Integer.toUnsignedLong(5));
        System.out.println("Uni is "+findUni);

        //
        University findUniversity = feignRestClient.findById(createdUniversity.getId());
        System.out.println("Uni is "+findUniversity);
